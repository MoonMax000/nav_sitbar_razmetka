...
const tabs = [
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 21 20" fill="none">
        <path
          d="M5.98131 12.9017C4.80234 13.6037 1.71114 15.0371 3.59389 16.8308C4.51359 17.707 5.53791 18.3337 6.82573 18.3337H14.1743C15.4621 18.3337 16.4864 17.707 17.4061 16.8308C19.2888 15.0371 16.1977 13.6037 15.0187 12.9017C12.254 11.2554 8.74599 11.2554 5.98131 12.9017Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M14.25 5.41699C14.25 7.48806 12.5711 9.16699 10.5 9.16699C8.42893 9.16699 6.75 7.48806 6.75 5.41699C6.75 3.34593 8.42893 1.66699 10.5 1.66699C12.5711 1.66699 14.25 3.34593 14.25 5.41699Z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
      </svg>
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 21 20" fill="none">
        <path
          d="M2.16602 9.16634C2.16602 6.41648 2.16602 5.04155 3.02029 4.18728C3.87456 3.33301 5.24949 3.33301 7.99935 3.33301H8.83268C11.5825 3.33301 12.9574 3.33301 13.8118 4.18728C14.666 5.04155 14.666 6.41648 14.666 9.16634V10.833C14.666 13.5828 14.666 14.9578 13.8118 15.8121C12.9574 16.6663 11.5825 16.6663 8.83268 16.6663H7.99935C5.24949 16.6663 3.87456 16.6663 3.02029 15.8121C2.16602 14.9578 2.16602 13.5828 2.16602 10.833V9.16634Z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
        <path
          d="M14.666 7.42187L14.7709 7.33529C16.5341 5.88052 17.4157 5.15313 18.1242 5.50434C18.8327 5.85556 18.8327 7.01995 18.8327 9.34874V10.6519C18.8327 12.9807 18.8327 14.1451 18.1242 14.4963C17.4157 14.8475 16.5341 14.1202 14.7709 12.6653L14.666 12.5787"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
        <path
          d="M10.084 9.16699C10.7743 9.16699 11.334 8.60735 11.334 7.91699C11.334 7.22664 10.7743 6.66699 10.084 6.66699C9.39363 6.66699 8.83398 7.22664 8.83398 7.91699C8.83398 8.60735 9.39363 9.16699 10.084 9.16699Z"
          stroke="currentColor"
          strokeWidth="1.5"
        />
      </svg>
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 21 20" fill="none">
        ...
        />
        <path
          d="M9.66602 13.5517C9.66602 15.9732 11.7183 17.9365 14.2493 17.9365C14.5469 17.9368 14.8437 17.9093 15.136 17.8545C15.3464 17.8149 15.4517 17.7952 15.5251 17.8064C15.5985 17.8176 15.7027 17.873 15.9108 17.9837C16.4997 18.2968 17.1863 18.4074 17.8468 18.2846C17.5958 17.9759 17.4243 17.6055 17.3487 17.2083C17.3028 16.9655 17.4164 16.7295 17.5865 16.5567C18.3591 15.7722 18.8327 14.7152 18.8327 13.5517C18.8327 11.1303 16.7803 9.16699 14.2493 9.16699C11.7183 9.16699 9.66602 11.1303 9.66602 13.5517Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinejoin="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 21 20" fill="none">
        <path
          d="M8.83398 11.1111C8.83398 10.8527 8.83398 10.7236 8.8624 10.6177C8.9394 10.3301 9.16407 10.1054 9.45165 10.0284C9.55757 10 9.68673 10 9.94507 10H11.0562C11.3146 10 11.4437 10 11.5497 10.0284C11.8372 10.1054 12.0619 10.3301 12.1389 10.6177C12.1673 10.7236 12.1673 10.8527 12.1673 11.1111V11.6667C12.1673 12.5872 11.4212 13.3333 10.5007 13.3333C9.58015 13.3333 8.83398 12.5872 8.83398 11.6667V11.1111Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M12.084 11.2503H13.0695C14.1396 11.2503 14.6747 11.2503 15.1303 11.1538C16.449 10.8745 17.5248 10.0176 17.9956 8.87158C18.1582 8.47566 18.2246 7.99659 18.3573 7.03841C18.4071 6.6787 18.4321 6.49885 18.4081 6.35173C18.3383 5.92328 17.995 5.57231 17.5324 5.45669C17.3736 5.41699 17.1727 5.41699 16.771 5.41699H4.23033C3.82857 5.41699 3.62769 5.41699 3.46887 5.45669C3.00633 5.57231 2.66296 5.92328 2.59318 6.35173C2.56922 6.49885 2.59414 6.6787 2.64397 7.03841C2.77672 7.99659 2.84308 8.47566 3.00572 8.87158C3.47648 10.0176 4.5523 10.8745 5.87095 11.1538C6.32652 11.2503 6.86163 11.2503 7.93184 11.2503H8.91732"
          stroke="currentColor"
          strokeWidth="1.5"
        />
        <path
          d="M3.41602 9.58301V11.2497C3.41602 14.3923 3.41602 15.9638 4.33809 16.94C5.26016 17.9163 6.74421 17.9163 9.71235 17.9163H11.2863C14.2545 17.9163 15.7385 17.9163 16.6606 16.94C17.5827 15.9638 17.5827 14.3923 17.5827 11.2497V9.58301"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M13.4173 5.41634L13.3529 5.122C13.0321 3.65528 12.8717 2.92193 12.4897 2.50247C12.1078 2.08301 11.6006 2.08301 10.5859 2.08301H10.4154C9.40073 2.08301 8.89348 2.08301 8.51156 2.50247C8.12963 2.92193 7.96922 3.65528 7.64838 5.122L7.58398 5.41634"
          stroke="currentColor"
          strokeWidth="1.5"
        />
      </svg>
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        />
        <path
          d="M6.66602 15.833C7.04809 17.2707 8.3956 18.333 9.99935 18.333C11.6031 18.333 12.9506 17.2707 13.3327 15.833"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        />
        <path
          d="M9.1529 6.37511C9.00665 4.90117 7.76308 3.75 6.25065 3.75C4.63982 3.75 3.33398 5.05583 3.33398 6.66667C3.33398 8.2775 4.63982 9.58333 6.25065 9.58333C6.54549 9.58333 6.83011 9.53958 7.09838 9.45825"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M14.5827 16.2497C14.5827 13.9485 12.5307 12.083 9.99935 12.083C7.46804 12.083 5.41602 13.9485 5.41602 16.2497"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M6.24935 9.58301C3.71804 9.58301 1.66602 11.4485 1.66602 13.7497"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        />
        <path
          d="M4.16602 13.75C5.17294 11.5991 8.92618 11.4576 9.99935 13.75M8.74935 7.91667C8.74935 8.83717 8.00316 9.58333 7.08268 9.58333C6.16221 9.58333 5.41602 8.83717 5.41602 7.91667C5.41602 6.99619 6.16221 6.25 7.08268 6.25C8.00316 6.25 8.74935 6.99619 8.74935 7.91667Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="mt-4">
              ...
              <div className="flex flex-col justify-center gap-4 p-4 h-[325px] rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
                  ...
                  <div className="flex items-start justify-between gap-4 p-2 px-4 rounded-lg border border-[#181B22] bg-[rgba(11,14,17,0.5)] backdrop-blur-[50px]">
                    ...
                    <div className="flex flex-col items-end gap-1">
                      <div className="flex items-center gap-1 px-1 py-0.5 rounded bg-[#3A2127]">
                        <span className="text-xs font-bold text-[#EF454A]">
                          -3.2%
                        </span>
                      </div>
                      <span className="text-xs font-bold text-webGray">
                ...
                <button className="flex items-center justify-center gap-2 h-[26px] px-4 py-2.5 rounded-lg bg-gradient-to-r from-primary to-[#482090] backdrop-blur-[50px] text-white font-bold text-sm hover:opacity-90 transition-opacity">
                  <svg width="20" height="20" viewBox="0 0 21 20" fill="none">
                    ...
                    />
                    <path
                      d="M16.5 2.08301L16.4079 2.33195C16.2871 2.65837 16.2267 2.82158 16.1077 2.94065C15.9886 3.05971 15.8253 3.12011 15.4989 3.24089L15.25 3.33301L15.4989 3.42512C15.8253 3.54591 15.9886 3.60631 16.1077 3.72537C16.2267 3.84443 16.2871 4.00764 16.4079 4.33407L16.5 4.58301L16.5921 4.33407C16.7129 4.00764 16.7733 3.84443 16.8923 3.72537C17.0114 3.60631 17.1747 3.54591 17.5011 3.42512L17.75 3.33301L17.5011 3.24089C17.1747 3.12011 17.0114 3.05971 16.8923 2.94065C16.7733 2.82158 16.7129 2.65837 16.5921 2.33195L16.5 2.08301Z"
                      stroke="white"
                      strokeWidth="1.5"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M16.5 10.417L16.4079 10.6659C16.2871 10.9923 16.2267 11.1556 16.1077 11.2747C15.9886 11.3937 15.8253 11.4541 15.4989 11.5749L15.25 11.667L15.4989 11.7591C15.8253 11.8799 15.9886 11.9403 16.1077 12.0593C16.2267 12.1784 16.2871 12.3417 16.4079 12.6681L16.5 12.917L16.5921 12.6681C16.7129 12.3417 16.7733 12.1784 16.8923 12.0593C17.0114 11.9403 17.1747 11.8799 17.5011 11.7591L17.75 11.667L17.5011 11.5749C17.1747 11.4541 17.0114 11.3937 16.8923 11.2747C16.7733 11.1556 16.7129 10.9923 16.5921 10.6659L16.5 10.417Z"
                      stroke="white"
                      strokeWidth="1.5"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M9 2.08301L8.90792 2.33195C8.78708 2.65837 8.72667 2.82158 8.60767 2.94065C8.48857 3.05971 8.32537 3.12011 7.99894 3.24089L7.75 3.33301L7.99894 3.42512C8.32537 3.54591 8.48857 3.60631 8.60767 3.72537C8.72667 3.84443 8.78708 4.00764 8.90792 4.33407L9 4.58301L9.09208 4.33407C9.21292 4.00764 9.27333 3.84443 9.39233 3.72537C9.51142 3.60631 9.67467 3.54591 10.0011 3.42512L10.25 3.33301L10.0011 3.24089C9.67467 3.12011 9.51142 3.05971 9.39233 2.94065C9.27333 2.82158 9.21292 2.65837 9.09208 2.33195L9 2.08301Z"
                      stroke="white"
                      strokeWidth="1.5"
                      strokeLinejoin="round"
                    />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-3 p-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <a
                    href="#"
                    className="whitespace-nowrap text-xs md:text-sm font-bold text-primary underline"
                  >
                    View All
                  </a>
                </div>
                ...
                <div className="flex flex-col gap-3 max-h-56 overflow-y-auto pr-1">
                  ...
                  {[
                    {
                      name: "RiskMaster - powerful tool for traders",
                      amount: "$39.99",
                      date: "06.12.25",
                      status: "Pending",
                    ...
                    {
                      name: "Momentum Brealout: Signals with ...",
                      amount: "$1.99",
                      date: "06.12.25",
                      status: "Declined",
                      statusColor: "text-[#EF454A]",
                    },
                    {
                      name: "BTC/USDT Grid-Bot HODL",
                      amount: "$9.99",
                    ...
                    >
                      <div className="flex-1 text-white font-normal">
                        {item.name}
                      </div>
                      <div className="w-14 text-center text-white font-bold">
                        {item.amount}
                      </div>
                      <div className="w-16 text-right text-white font-normal">
                        {item.date}
                      </div>
                      <div
                        className={`w-16 text-right font-bold ${item.statusColor}`}
                      >
                        {item.status}
                      </div>
                    </div>
              ...
              <div className="flex flex-col justify-between gap-4 p-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
                ...
                <div className="flex flex-col gap-4 flex-1">
                  {[
                    {
                      image:
                        "https://api.builder.io/api/v1/image/assets/TEMP/5dad0d4f76c7f3927fd2ce9dfc5e32e8a9127e58?width=244",
                      name: "RiskMaster - powerful tool for traders",
                    },
                    {
                      image:
                        "https://api.builder.io/api/v1/image/assets/TEMP/ca710cd801967c54c06ec127f796d210acf62902?width=244",
                      name: "Momentum Brealout: Signals with 65% accuracy",
                    },
                    {
                      image:
                        "https://api.builder.io/api/v1/image/assets/TEMP/a049817adf1840513df051b8d1be7ee4276c4801?width=244",
                      name: "BTC/USDT Grid-Bot HODL",
                    },
                    {
                      image:
                    ...
                    <div key={idx} className="flex items-center gap-2">
                      <img
                        src={item.image}
                        alt={item.name}
                        className="w-[122px] h-16 rounded-lg object-cover"
                      />
                ...
                <button className="flex items-center justify-center gap-1 h-[26px] px-4 py-2.5 rounded-lg bg-gradient-to-r from-primary to-[#482090] backdrop-blur-[50px] text-white font-bold text-sm hover:opacity-90 transition-opacity">
                  <svg width="20" height="20" viewBox="0 0 21 20" fill="none">
                    <path
                      d="M7.39258 11.9422C7.39258 13.0172 8.21758 13.8838 9.24259 13.8838H11.3343C12.2259 13.8838 12.9509 13.1255 12.9509 12.1922C12.9509 11.1755 12.5093 10.8172 11.8509 10.5838L8.49257 9.41715C7.83424 9.18382 7.39258 8.82549 7.39258 7.80885C7.39258 6.87552 8.11757 6.11719 9.00926 6.11719H11.1009C12.1259 6.11719 12.9509 6.98385 12.9509 8.05885"
                      stroke="white"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    ...
                    />
                    <path
                      d="M10.1654 18.3327C14.7677 18.3327 18.4987 14.6017 18.4987 9.99935C18.4987 5.39697 14.7677 1.66602 10.1654 1.66602C5.56299 1.66602 1.83203 5.39697 1.83203 9.99935C1.83203 14.6017 5.56299 18.3327 10.1654 18.3327Z"
                      stroke="white"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="flex flex-col justify-between gap-4 p-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
                ...
                <div className="flex flex-col gap-2.5 flex-1">
                  {[
                    {
                      name: "Crypto Expert",
                      desc: "High-risk BTC Strategy with sharp swings",
                      growth: "+12.3%",
                      growthColor: "text-green",
                    },
                    {
                      name: "Long-Term HODL",
                      desc: "Steady ETH-focused portfolio for long-term gains",
                      growth: "+4.8%",
                      growthColor: "text-green",
                    },
                    {
                      name: "DeFi Radar",
                      desc: "Yield farming and token rotation",
                      growth: "-2.1%",
                      growthColor: "text-[#EF454A]",
                    },
                  ].map((portfolio, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-2 p-2 px-4 rounded-2xl border border-[#181B22] bg-[rgba(11,14,17,0.5)] backdrop-blur-[50px]"
                    >
                      <div className="flex flex-col gap-1 flex-1">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <span
                            className={`text-xs font-bold uppercase ${portfolio.growthColor}`}
                          >
                            {portfolio.growth}
                          </span>
                        </div>
                      ...
                      >
                        <path
                          d="M9.66797 6.33301L15.668 12.333L9.66797 18.333"
                          stroke="#A06AFF"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                ...
                <button className="flex items-center justify-center gap-1 h-[26px] px-4 py-2.5 rounded-lg bg-gradient-to-r from-primary to-[#482090] backdrop-blur-[50px] text-white font-bold text-sm hover:opacity-90 transition-opacity">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    />
                    <path
                      d="M11.502 10.8333C11.7616 10.7579 12.0561 10.6671 12.4006 10.5608L15.8766 9.48883C17.1138 9.10733 17.7193 8.4425 17.851 7.29148C17.9099 6.77665 17.9394 6.51923 17.898 6.30852C17.7797 5.7072 17.2747 5.21962 16.6017 5.05699C16.3659 5 16.0698 5 15.4776 5H4.52362C3.93148 5 3.63542 5 3.39957 5.05699C2.72657 5.21962 2.22157 5.7072 2.10334 6.30852C2.06191 6.51923 2.09137 6.77665 2.15028 7.29148C2.28202 8.4425 2.88752 9.10733 4.12467 9.48883L7.60062 10.5608C7.94512 10.6671 8.23968 10.7579 8.49932 10.8333"
                      stroke="white"
                      strokeWidth="1.5"
                    />
                    <path
                      d="M2.88569 9.16602L2.72215 10.9763C2.42901 14.2212 2.28243 15.8436 3.22278 16.8798C4.16313 17.916 5.78209 17.916 9.02 17.916H10.98C14.2179 17.916 15.8368 17.916 16.7772 16.8798C17.7176 15.8436 17.571 14.2212 17.2778 10.9763L17.1143 9.16602"
                      stroke="white"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M12.9173 4.58398L12.8529 4.36323C12.5321 3.26319 12.3717 2.71318 11.9897 2.39858C11.6078 2.08398 11.1006 2.08398 10.0859 2.08398H9.9154C8.90073 2.08398 8.39348 2.08398 8.01156 2.39858C7.62963 2.71318 7.46922 3.26319 7.14838 4.36323L7.08398 4.58398"
                      stroke="white"
                      strokeWidth="1.5"
                    />
                  </svg>
              ...
              <div className="absolute left-4 top-4">
                <div className="relative">
                  ...
                  <button className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-black/0 hover:bg-black/50 transition-all backdrop-blur-0 hover:backdrop-blur-[50px] rounded-2xl group">
                    ...
                    <span className="text-xs text-webGray opacity-0 group-hover:opacity-100 transition-opacity text-center px-2 font-bold">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1 flex flex-col gap-2">
                  <label className="text-xs font-bold uppercase text-webGray">
                    Display name
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex-1 flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      <path
                        d="M4.16602 12.083C4.16602 12.083 5.41602 12.083 7.08268 14.9997C7.08268 14.9997 11.715 7.36078 15.8327 5.83301"
                        stroke="#2EBD85"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
              ...
              <div className="flex flex-col md:flex-row gap-4 md:gap-6">
                <div className="w-full md:w-80 flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    >
                      <path
                        d="M7.05807 8.9502L9.99974 11.8835L12.9414 8.9502"
                        stroke="#B0B0B0"
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 p-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
              <div className="flex justify-center items-center gap-2.5 pb-2">
                <h3 className="flex-1 text-2xl font-bold text-white">
                  Account
                </h3>
              </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex flex-col gap-1 flex-1">
                  ...
                  <p className="text-sm font-normal text-webGray">
            ...
            <div className="flex flex-col gap-4 p-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex flex-col gap-1 flex-1">
                  ...
                  <p className="text-sm font-normal text-webGray">
                    Temporarily hide your profile and pause notifications. You
                    can reactivate at any time by logging in.
                  </p>
                </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex flex-col gap-1 flex-1">
                  ...
                  <p className="text-sm font-normal text-webGray">
                    Permanently remove your profile and all related data. This
        ...
        {activeTab === "profile" &&
          ...
          activeProfileSubTab !== "notifications" &&
          activeProfileSubTab !== "billing" &&
          activeProfileSubTab !== "referrals" &&
          activeProfileSubTab !== "kyc" && (
            <div className="container-card p-6">
              <h2 className="text-2xl font-bold text-white capitalize">
                {activeProfileSubTab}
              </h2>
              <p className="mt-2 text-sm text-webGray">
                Content for {activeProfileSubTab} tab will be here.
              </p>
            </div>
          )}
        ...
        {activeTab === "streaming" && <LiveStreamingSettings />}
