  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="mt-4">
        ...
        {activeTab === 'profile' && activeProfileSubTab !== 'profile' && activeProfileSubTab !== 'security' && activeProfileSubTab !== 'notifications' && activeProfileSubTab !== 'billing' && activeProfileSubTab !== 'referrals' && (
