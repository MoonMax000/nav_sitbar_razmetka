  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col items-center gap-4 md:gap-6 flex-1 self-stretch'>
        <h3 className={cn('text-center text-xl md:text-3xl font-bold leading-[100%] transition-all duration-300 group-hover:scale-105 tracking-wide', titleClasses)}>
          {title.toUpperCase()}
        </h3>
        ...
        <div className='flex flex-col items-center gap-4 self-stretch'>
          <div className='flex flex-col justify-center items-center gap-1 self-stretch'>
            <div className='flex items-baseline gap-2 group-hover:scale-110 transition-transform duration-300'>
              <span className='text-primary text-xl md:text-3xl font-bold leading-[100%]'>{planData.price}</span>
              <span className='text-webGray text-xs md:text-sm font-bold'>{periodText}</span>
            </div>
            <div className='text-webGray text-center text-xs md:text-sm font-bold self-stretch'>Annual Total: {planData.annual}</div>
          </div>
        ...
        <button className='flex h-[26px] py-[15px] px-8 md:px-16 justify-center items-center gap-2 self-stretch rounded-lg bg-gradient-to-r from-primary to-[#482090] relative overflow-hidden group/btn transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/30 active:scale-95'>
          ...
          <span className='text-white text-xs md:text-sm font-bold relative z-10'>{buttonText}</span>
        </button>
            ...
            >
              <div className='flex-shrink-0 mt-0.5 group-hover/feature:scale-110 group-hover/feature:rotate-12 transition-all duration-300'>
                <div className='w-4 h-4 rounded-full bg-gradient-to-br from-primary to-[#482090] flex items-center justify-center shadow-lg shadow-primary/30 group-hover/feature:shadow-primary/50'>
                  <svg width='10' height='8' viewBox='0 0 12 9' fill='none' className='text-white'>
                    <path d='M1 4.5L4.5 8L11 1' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
                  </svg>
                </div>
              </div>
              <div className='flex flex-col gap-0.5 flex-1'>
                <h4 className='text-white text-xs md:text-sm font-bold group-hover/feature:text-primary transition-colors duration-300'>{feature.split(':')[0]}</h4>
      ...
      <div className='flex flex-col items-center gap-6'>
        <h1 className='relative text-4xl md:text-5xl font-bold text-center'>
          <span className='relative inline-block'>
            <span className='absolute inset-0 bg-gradient-to-r from-primary via-[#6AA5FF] to-[#482090] bg-clip-text text-transparent animate-gradient-xy' style={{backgroundSize: '200% 200%'}}>
              Choose Your Plan
            </span>
            <span className='relative bg-gradient-to-r from-primary via-[#6AA5FF] to-[#482090] bg-clip-text text-transparent'>
              Choose Your Plan
            </span>
            <span className='absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent bg-clip-text text-transparent animate-shine' style={{backgroundSize: '200% 100%'}} />
          </span>
        </h1>
        ...
        <div className='flex flex-col items-center gap-3'>
          ...
          <div className='relative inline-flex p-[3px] rounded-full border-2 border-[#181B22]/50 bg-gradient-to-br from-[#181B22]/80 to-[#0C1014]/90 backdrop-blur-[100px] shadow-2xl shadow-black/50 w-[320px] max-w-full'>
            <div className={cn(
              ...
              billingPeriod === 'monthly' ? 'left-[3px] w-[calc(50%-3px)]' : 'left-[calc(50%)] w-[calc(50%-3px)]'
            )}
            style={{
              backdropFilter: 'blur(20px)',
              boxShadow: '0 0 20px rgba(160, 106, 255, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)'
            }}
            />
            <div className='relative grid grid-cols-2 w-full z-10'>
              <button
                ...
                className={cn(
                  ...
                  billingPeriod === 'monthly' ? 'text-white' : 'text-webGray/70 hover:text-white'
                )}
              ...
              <button
                ...
                className={cn(
                  'px-6 py-2.5 rounded-full text-sm font-bold transition-all duration-300',
                  billingPeriod === 'yearly' ? 'text-white' : 'text-webGray/70 hover:text-white'
                )}
