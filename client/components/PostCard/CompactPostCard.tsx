      ...
      <div className="flex min-w-0 flex-1 flex-col items-start gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex min-w-0 flex-1 flex-col items-start">
            <div className="truncate text-sm font-semibold text-white">{author.name}</div>
            <div className="text-xs font-medium text-[#808283]">{timestamp}</div>
          </div>
        </div>
        ...
        <div className="flex w-full items-center gap-2">
          ...
          {/* Sentiment badge */}
          <div className={`flex items-center gap-1 rounded px-1.5 py-0.5 ${sentiment === 'bullish' ? 'bg-[#1C3430]' : 'bg-[#3A1E1F]'}`}>
            <svg width="12" height="12" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              {sentiment === 'bullish' ? (
                <>
                  <path
            ...
            <div className={`text-xs font-semibold ${sentiment === 'bullish' ? 'text-[#2EBD85]' : 'text-[#EF454A]'}`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="text-xs font-semibold text-[#A06AFF]">{likes >= 1000 ? `${(likes / 1000).toFixed(1)}K` : likes}</div>
            </div>
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="text-xs font-semibold text-[#808283]">{comments}</div>
            </div>
          </div>
        </div>
      </div>
