  ...
  const tabs: Tab[] = [
    {
      ...
      icon: (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M11.2503 15.8334V16.6667C11.2503 17.4524 11.2503 17.8452 11.0062 18.0893C10.7622 18.3334 10.3693 18.3334 9.58366 18.3334C8.79799 18.3334 8.40516 18.3334 8.16107 18.0893C7.91699 17.8452 7.91699 17.4524 7.91699 16.6667V15.8334" stroke="white" strokeWidth="1.5" strokeLinejoin="round"/>
        </svg>
      ),
    },
    {
      ...
      <div className="flex flex-wrap items-center gap-1 sm:gap-1">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center justify-center gap-2 rounded-[32px] px-2.5 py-3 transition-all duration-300 backdrop-blur-[58px] ${
              activeTab === tab.id
                ? 'bg-gradient-to-r from-[#A06AFF] to-[#482090]'
                : 'border border-[#181B22] bg-[rgba(12,16,20,0.50)]'
            }`}
          >
            <div className={activeTab === tab.id ? '[&_path]:stroke-white' : '[&_path]:stroke-[#B0B0B0]'}>
              {tab.icon}
            </div>
            <span
