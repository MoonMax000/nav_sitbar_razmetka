...
type TabId = 'ideas' | 'opinions' | 'analytics' | 'softwares' | 'videos' | 'liked';
...
const UserTabs: FC<Props> = ({ isOwn = true, viewMode = 'normal' }) => {
    ...
    () => ({
      ideas: [
        ...
        },
        {
          ...
          image: 'https://api.builder.io/api/v1/image/assets/TEMP/7da696181764ec7a3a8683ab01b16c0daac1ab16?width=1198',
          sentiment: 'bullish',
          likes: 980,
          comments: 201,
        },
      ...
      opinions: [
        {
          ...
          image: 'https://api.builder.io/api/v1/image/assets/TEMP/eacd3fbf97330649a97100e9a7099651e9a0fdb4?width=1198',
          sentiment: 'bullish',
          likes: 640,
          comments: 142,
        },
      ...
      analytics: [
        {
          ...
          image: 'https://api.builder.io/api/v1/image/assets/TEMP/4c8ef9d846ef46a09cccefd4aaa3cdd3c3a0de47?width=1198',
          sentiment: 'bullish',
          likes: 312,
          comments: 88,
        },
      ...
      },
      {
        ...
        icon: (
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M2.08301 7.5H17.9163" stroke="#B0B0B0" strokeWidth="1.5" strokeLinejoin="round" />
            <path d="M5.83301 5H5.84049" stroke="#B0B0B0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9.16602 5H9.17352" stroke="#B0B0B0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M6.66699 10.8334L7.68911 11.7144C8.11881 12.0847 8.33366 12.27 8.33366 12.5C8.33366 12.7301 8.11881 12.9154 7.68911 13.2857L6.66699 14.1667" stroke="#B0B0B0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M10 14.1666H13.3333" stroke="#B0B0B0" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        ),
      },
      {
        ...
        icon: (
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.66699 9.16671C1.66699 6.41685 1.66699 5.04192 2.52127 4.18765C3.37553 3.33337 4.75047 3.33337 7.50033 3.33337H8.33366C11.0835 3.33337 12.4584 3.33337 13.3127 4.18765C14.167 5.04192 14.167 6.41685 14.167 9.16671V10.8334C14.167 13.5832 14.167 14.9581 13.3127 15.8125C12.4584 16.6667 11.0835 16.6667 8.33366 16.6667H7.50033C4.75047 16.6667 3.37553 16.6667 2.52127 15.8125C1.66699 14.9581 1.66699 13.5832 1.66699 10.8334V9.16671Z" stroke="#B0B0B0" strokeWidth="1.5" />
            <path d="M14.167 7.4215L14.2719 7.33493C16.0351 5.88015 16.9167 5.15276 17.6252 5.50398C18.3337 5.85519 18.3337 7.01959 18.3337 9.34838V10.6515C18.3337 12.9804 18.3337 14.1447 17.6252 14.496C16.9167 14.8471 16.0351 14.1198 14.2719 12.665L14.167 12.5784" stroke="#B0B0B0" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M9.58301 9.16663C10.2734 9.16663 10.833 8.60698 10.833 7.91663C10.833 7.22627 10.2734 6.66663 9.58301 6.66663C8.89265 6.66663 8.33301 7.22627 8.33301 7.91663C8.33301 8.60698 8.89265 9.16663 9.58301 9.16663Z" stroke="#B0B0B0" strokeWidth="1.5" />
          </svg>
        ),
      },
      {
  ...
  const renderEmptyState = (tabId: TabId) => (
    <div className="flex flex-col items-center justify-center gap-3 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.40)] p-6 text-center backdrop-blur-[50px]">
      <h4 className="text-lg font-bold text-white">No {tabs.find((tab) => tab.id === tabId)?.label.toLowerCase()} yet</h4>
    ...
    <div className="flex w-full flex-col gap-6">
      <div className="flex flex-wrap items-center gap-1 sm:gap-1">
        {tabs.map((tab) => (
          ...
          >
            <span className={`${activeTab === tab.id ? '[&_path]:stroke-white [&_path]:fill-white/20' : '[&_path]:stroke-[#B0B0B0]'}`}>
              {tab.icon}
            </span>
            {tab.label}
          </button>
