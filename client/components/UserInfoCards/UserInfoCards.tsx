...
const UserInfoCards: FC = () => {
  return (
    <div className="flex flex-col sm:flex-row items-start gap-4">
      ...
      <div className="flex items-center gap-2 px-4 py-[18px] rounded-2xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] w-full sm:w-auto">
        ...
        <span className="text-[15px] font-bold text-white whitespace-nowrap">Individual Investor</span>
      </div>

      {/* Followers Card */}
      <div className="flex flex-col justify-center items-center gap-1 px-2 py-2 flex-1 rounded-2xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] min-w-[100px]">
