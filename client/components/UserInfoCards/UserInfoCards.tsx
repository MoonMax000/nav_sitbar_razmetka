...
const UserInfoCards: FC = () => {
  return (
    <div className="flex w-full flex-col gap-3">
      <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-black px-3 py-2.5 md:px-4 md:py-3">
      ...
      <div className="rounded-xl border border-white/10 bg-black px-3 py-3 md:px-4 md:py-4">
