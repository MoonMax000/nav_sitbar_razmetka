  ...
  return (
    <div className="flex w-full flex-col gap-3">
      ...
      <div className="flex flex-col gap-2 md:gap-3">
        ...
        {/* Horizontal info row */}
        <div className="flex w-full flex-nowrap items-stretch gap-2 overflow-x-auto rounded-2xl border border-[#2F3336] bg-[#16181C]/80 p-2 backdrop-blur-xl md:gap-3 md:p-3">
          {/* Profile tier */}
          <div className="flex min-w-[170px] items-center gap-2 rounded-xl border border-white/12 bg-black/30 px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]">
            <svg width="18" height="18" viewBox="0 0 20 20" fill="none" className="flex-shrink-0">
              <path
                d="M16.6663 18.3335V14.1668C16.6663 12.5955 16.6663 11.8098 16.1782 11.3217C15.69 10.8335 14.9043 10.8335 13.333 10.8335L9.99967 18.3335L6.66634 10.8335C5.09499 10.8335 4.30932 10.8335 3.82117 11.3217C3.33301 11.8098 3.33301 12.5955 3.33301 14.1668V18.3335"
                stroke="#8B98A5"
            ...
            <span className="text-sm font-medium text-[#F7F9F9]">
              Individual Investor
            </span>
          </div>

          {/* Followers */}
          <div className="flex min-w-[120px] flex-col items-center justify-center gap-0.5 rounded-xl border border-white/10 bg-black/25 px-3 py-2 text-center md:flex-1 md:px-4 md:py-3">
            <span className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#8B98A5]">
              Followers
            </span>
          ...
          {/* Markets */}
          <div className="flex min-w-[180px] items-center justify-center gap-2 rounded-xl border border-white/10 bg-black/25 px-3 py-2 md:flex-1 md:px-4 md:py-3">
            <svg width="18" height="18" viewBox="0 0 20 20" fill="none" className="flex-shrink-0">
            ...
            <div className="flex flex-col items-start md:items-center">
              ...
              <span className="text-sm font-medium text-[#F7F9F9] md:text-xs">
                Stock · Crypto · Forex
              </span>
            </div>
          </div>
