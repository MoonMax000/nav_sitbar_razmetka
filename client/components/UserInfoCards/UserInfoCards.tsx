...
const UserInfoCards: FC = () => {
  return (
    <div className="flex w-full flex-col gap-4 sm:flex-row sm:flex-wrap">
      <div className="flex w-full items-center gap-2 rounded-2xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] px-4 py-[18px] shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] sm:min-w-[240px]">
      ...
      <div className="flex w-full min-w-[140px] flex-col items-center justify-center gap-1 rounded-2xl border border-[#181B22] bg-[rgba(12,16,20,0.5)] px-2 py-2 text-center shadow-[0_4px_8px_0_rgba(0,0,0,0.24)] backdrop-blur-[50px] sm:flex-1">
