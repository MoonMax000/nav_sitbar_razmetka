    ...
    >
      ...
      >
        ...
        <div className="border-t border-[#181B22] px-5 py-3">
          <div className="grid" style={{ gridTemplateColumns: "repeat(5, auto) 1fr auto", gap: "0.75rem", alignItems: "center" }}>
            <button type="button" className="flex h-10 w-10 items-center justify-center rounded-full text-[#A06AFF] transition-colors hover:bg-[#482090]/10" title="Видео или GIF">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M23 7l-7 5 7 5V7z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <rect x="1" y="5" width="14" height="14" rx="2" stroke="currentColor" strokeWidth="1.5" />
              </svg>
            </button>
            <button type="button" className="flex h-10 w-10 items-center justify-center rounded-full text-[#A06AFF] transition-colors hover:bg-[#482090]/10" title="Опрос">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M3 12h4v7H3zM10 7h4v12h-4zM17 3h4v16h-4z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
            ...
            <div className="flex items-center gap-3 justify-end">
              <button onClick={() => setSentiment("bullish")} className={`rounded inline-flex items-center gap-1 px-2.5 py-1 text-xs font-bold transition-colors ${sentiment === "bullish" ? "bg-[#1C3430] text-white" : "bg-white/5 text-white/40 hover:text-white"}`} disabled={isPosting}>
              ...
              <button onClick={() => setSentiment("bearish")} className={`rounded inline-flex items-center gap-1 px-2.5 py-1 text-xs font-bold transition-colors ${sentiment === "bearish" ? "bg-[#3A2127] text-white" : "bg-white/5 text-white/40 hover:text-white"}`} disabled={isPosting}>
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
