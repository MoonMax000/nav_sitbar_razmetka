    ...
    <div className={cn('relative w-full', className)}>
      ...
      <div className="relative w-full h-48 rounded-3xl mb-16 sm:mb-20">
        <div className="w-full h-full overflow-hidden rounded-3xl">
          ...
          {isOwn && (
            <button className="absolute right-4 bottom-4 inline-flex items-center justify-center gap-2 px-3 py-3 rounded-[32px] border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[58px] hover:bg-[rgba(12,16,20,0.7)] transition-colors z-20">
      ...
      {/* User info section */}
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 px-4 sm:px-0">
        {/* Left side - User details */}
        <div className="flex flex-col gap-2 ml-0 sm:ml-44">
        ...
        {/* Right side - Badges */}
        <div className="flex items-center gap-4 ml-0 sm:ml-0">
          {/* Tier badge */}
