...
const UserHeader: FC<Props> = ({ isOwn = true, className }) => {
  return (
    <div className={cn('relative w-full', className)}>
      ...
      {/* Stats and action buttons below hero */}
      <div className="mt-6 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        {/* Stats card */}
        <div className="flex flex-col gap-2 p-4 rounded-lg border border-[#181B22] bg-[rgba(11,14,17,0.5)] backdrop-blur-[50px] w-full lg:w-auto">
