...
const UserHeader: FC<Props> = ({ isOwn = true, className }) => {
  ...
  return (
    <div className={cn("flex flex-col w-full", className)}>
      ...
      <div className="flex items-center gap-9 px-4 py-1 bg-black">
        <button
          onClick={() => navigate(-1)}
      ...
      <div className="relative w-full h-[200px] bg-[#16181C]">
        ...
        <div className="absolute left-4 -bottom-[66px] w-[132px] h-[132px] rounded-full border-4 border-black">
          <img
      ...
      <div className="flex justify-end items-start gap-3 px-4 py-3">
        <button className="flex items-center justify-center p-2 rounded-full border border-[#39444D] hover:bg-white/10 transition-colors">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path
        ...
        {isOwn ? (
          <button className="flex items-center justify-center px-5 py-2 rounded-full bg-[#F7F9F9] hover:bg-[#E7E9E9] transition-colors">
            <span className="text-black text-center font-bold text-[15px] leading-5">
              Edit profile
            </span>
          </button>
        ) : (
