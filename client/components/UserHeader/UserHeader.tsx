  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="h-48 w-full backdrop-blur-[17.4px] bg-black/[0.01]">
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/5 to-black/20" />
        </div>
      </div>

      {/* Main content */}
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 px-6 pt-4 pb-6">
        {/* Left: Avatar & Info */}
        <div className="flex items-center gap-4 md:gap-6">
          ...
          <div className="flex flex-col justify-between h-32 md:h-40">
            <div className="flex items-center gap-2">
              <div className="flex flex-col">
                <div className="flex items-center gap-1">
                  ...
                  <svg width="24" height="25" viewBox="0 0 24 25" fill="none" className="flex-shrink-0">
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_18_2379" x1="21.5" y1="12.5" x2="2.5" y2="12.5" gradientUnits="userSpaceOnUse">
              ...
              <div className="flex items-center gap-1 px-2 py-0.5 rounded bg-[#1C3430]">
                <svg width="12" height="13" viewBox="0 0 12 13" fill="none">
                  <g clipPath="url(#clip0_18_2389)">
                  ...
                  <defs>
                    <clipPath id="clip0_18_2389">
                      <rect width="12" height="12" fill="white" transform="translate(0 0.5)" />
                    </clipPath>
                  </defs>
                </svg>
                <span className="text-xs font-bold text-green">KYC Verified</span>
              </div>
            </div>

            {/* Stats card */}
            <div className="flex items-center gap-3 p-4 rounded-lg border border-[#181B22] bg-[rgba(11,14,17,0.5)] backdrop-blur-[50px]">
              <div className="flex flex-col gap-1">
                <span className="text-xs font-bold uppercase text-white">Followers</span>
                <span className="text-sm md:text-base font-bold text-white">3020</span>
              </div>
              <div className="w-px h-9 bg-[#523A83]" />
              <div className="flex flex-col gap-1">
                <span className="text-xs font-bold uppercase text-white">Following</span>
                <span className="text-sm md:text-base font-bold text-white">678</span>
              </div>
              <div className="w-px h-9 bg-[#523A83]" />
              <div className="flex flex-col gap-1">
                <span className="text-xs font-bold uppercase text-white">Posts</span>
                <span className="text-sm md:text-base font-bold text-white">23</span>
              </div>
              <div className="w-px h-9 bg-[#523A83]" />
              <div className="flex flex-col gap-1">
                <span className="text-xs font-bold uppercase text-white">Products</span>
                <span className="text-sm md:text-base font-bold text-white">4</span>
              </div>
              <div className="w-px h-9 bg-[#523A83]" />
              <div className="flex flex-col gap-1">
                <span className="text-xs font-bold uppercase text-white">Orders</span>
                <span className="text-sm md:text-base font-bold text-white">5</span>
              </div>
              <div className="w-px h-9 bg-[#523A83]" />
              <div className="flex flex-col gap-1">
                <span className="text-xs font-bold uppercase text-white">Consultations</span>
                <span className="text-sm md:text-base font-bold text-white">3</span>
              </div>
            </div>
          ...
          <div className="hidden lg:flex items-center gap-2.5">
            <svg width="18" height="20" viewBox="0 0 18 20" fill="none">
              <path fillRule="evenodd" clipRule="evenodd" d="M0 9.99405L0.000809188 10.0552C1.93095 9.65939 3.87139 9.24601 5.8154 8.83182L5.81898 18.6573L12.3592 20C12.3592 17.8424 12.339 11.7641 12.3603 9.60702L7.78392 8.66756L7.17484 8.5426C10.5969 7.81537 14.0251 7.09773 17.4225 6.47986L17.4214 0C11.6755 1.17922 5.76419 2.5731 0 3.57557L0 9.99405Z" fill="url(#paint0_linear_18_2420)" />
              <defs>
                <linearGradient id="paint0_linear_18_2420" x1="4.23118" y1="21.5" x2="11.7564" y2="1.27175" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#181A20" />
                  <stop offset="1" stopColor="#A06AFF" />
                </linearGradient>
              </defs>
            </svg>
            <span className="text-sm md:text-base font-bold text-white">since Feb 10, 2024</span>
          </div>
        </div>
        ...
        {isOwn && (
          <div className="flex flex-wrap items-start gap-4 w-full md:w-auto">
            <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px] text-white font-bold text-sm md:text-base hover:bg-[rgba(12,16,20,0.7)] transition-colors">
            ...
            <button className="flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r from-primary to-[#482090] backdrop-blur-[50px] text-white font-bold text-sm md:text-base hover:opacity-90 transition-opacity">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <g clipPath="url(#clip0_18_2434)">
