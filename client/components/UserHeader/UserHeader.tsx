  ...
  return (
    <div className={cn('relative w-full', className)}>
      ...
      <div className="relative w-full h-48 overflow-hidden rounded-3xl mb-16 sm:mb-20">
        ...
        {isOwn && (
          <button className="absolute right-4 bottom-4 inline-flex items-center justify-center gap-2 px-3 py-3 rounded-[32px] border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[58px] hover:bg-[rgba(12,16,20,0.7)] transition-colors">
