  ...
  users = [
    {
      ...
      avatar: 'https://api.builder.io/api/v1/image/assets/TEMP/8e3b0efd989b9330e9b1406ea6bafe5a6b9b839c?width=88',
      isVerified: true,
    },
    {
      id: '2',
      ...
      avatar: 'https://api.builder.io/api/v1/image/assets/TEMP/81d1c234a83ddeb322db8633598e8c5a4c78503c?width=88',
      isVerified: true,
    },
    {
      id: '3',
      ...
      avatar: 'https://api.builder.io/api/v1/image/assets/TEMP/f2a55308ba04a202232a08ce7a7a3770e9d4401a?width=88',
      isVerified: true,
    },
    {
      id: '4',
      ...
      avatar: 'https://api.builder.io/api/v1/image/assets/TEMP/9b3ef2151f785f297c849bb8857e447398bb4dec?width=88',
      isVerified: true,
    },
  ],
}) => {
        ...
        return (
          <div key={user.id} className="flex items-center gap-2 self-stretch">
            ...
            <div className="flex flex-1 flex-col items-start gap-0.5">
              ...
              <span className="text-xs font-bold leading-normal text-[#B0B0B0]">{user.username}</span>
            </div>
            <button
              type="button"
