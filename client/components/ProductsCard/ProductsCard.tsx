      ...
      {users.map((user) => (
        <div key={user.id} className="flex items-center gap-2 self-stretch">
          ...
          <div className="flex flex-1 flex-col items-start gap-0.5">
            ...
            <div className="self-stretch text-xs font-bold leading-normal text-[#B0B0B0]">
              {user.username}
            </div>
          </div>
          <button className="flex h-[26px] w-20 items-center justify-center gap-2.5 rounded-lg bg-gradient-to-r from-[#A06AFF] to-[#482090] px-2.5 py-2.5">
