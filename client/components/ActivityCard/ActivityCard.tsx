        ...
        {visibleProducts.map((product, index) => (
          <div
            ...
            className={`flex items-center gap-2 self-stretch ${
              index < visibleProducts.length - 1 ? 'border-b border-[#181B22] pb-3' : ''
            }`}
          >
            <button
              type="button"
            ...
            >
              <img src={product.thumbnail} alt={product.title} className="h-full w-full object-cover transition-transform duration-300 group-hover:scale-[1.05]" />
            </button>
