...
const LoginModal: FC<LoginModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative z-10 flex max-w-4xl w-full rounded-[25px] overflow-hidden">
        {/* Left Panel - Auth Form */}
        <div className="w-full md:w-[393px] flex items-center justify-center p-6 md:p-8 rounded-l-[25px] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px] border border-[#181B22]">
          <div className="w-full max-w-[341px] flex flex-col gap-4">
            {/* Title */}
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="inline-flex items-center gap-3 p-1 rounded-[36px] border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
                <button
                  ...
                  className={cn(
                    'flex items-center justify-center h-8 px-4 rounded-[32px] text-[15px] font-bold transition-all',
                    authMethod === 'phone'
              ...
              <button className="flex items-center justify-center w-[26px] h-[26px] rounded-lg border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
            ...
            <div className="flex flex-col gap-6">
              {/* Email/Phone Input */}
              <div className="flex items-center gap-2 h-11 px-3 rounded-lg border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
              ...
              {/* Password Input */}
              <div className="flex items-center justify-between gap-2 h-11 px-3 rounded-lg border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px]">
              ...
              <div className="flex flex-col items-center gap-2">
                <button className="w-full h-11 flex items-center justify-center rounded-lg bg-gradient-to-r from-primary to-[#482090] text-[15px] font-bold text-white hover:opacity-90 transition-opacity">
                  Sign In
                </button>
            ...
            <div className="flex items-center justify-center gap-6 mt-2">
              <button className="flex items-center justify-center w-11 h-11 rounded-full border border-[#181B22] bg-[rgba(12,16,20,0.5)] backdrop-blur-[50px] hover:bg-[rgba(12,16,20,0.7)] transition-all">
            ...
            <div className="flex items-center gap-2 my-2">
              <div className="h-px flex-1 bg-gradient-to-r from-[#482090] to-primary" />
              <span className="text-[15px] font-bold text-webGray">or</span>
              <div className="h-px flex-1 bg-gradient-to-r from-primary to-[#482090]" />
            </div>

            {/* Email Button */}
            <button className="flex items-center justify-center gap-2 h-11 rounded-lg border border-[#181B22] bg-[rgba(11,14,17,0.5)] backdrop-blur-[50px] hover:bg-[rgba(11,14,17,0.7)] transition-all">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M1.66675 5L7.4276 8.26414C9.55141 9.4675 10.4487 9.4675 12.5726 8.26414L18.3334 5" stroke="#B0B0B0" strokeWidth="1.5" strokeLinejoin="round"/>
        ...
        <div className="hidden md:flex w-[393px] flex-col items-center justify-center gap-12 p-8 rounded-r-[25px] bg-[rgba(11,14,17,0.72)] backdrop-blur-[50px]">
